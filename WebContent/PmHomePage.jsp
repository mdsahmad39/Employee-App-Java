...
<body>
	<nav class="navbar">
		...
		<a class="btn btn-light" href="PmHomePage.jsp" id="btn-home">Home</a> <a
			class="btn btn-warning" href="Login.html" id="btn-logout">Log Out</a>
	</nav>

	<h1 id="title">Welcome to Project Manager Home Page</h1>
	<h3 id="btn-block">
		<a type="button" class="btn btn-outline-primary  btn-lg"
			href='GetEmployeesPm'>Get All Employees</a>
	</h3>
